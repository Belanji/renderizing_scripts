#!/home/souzarf/Programas/ParaView/5.6.0/bin/pvbatch
...
PyramidBase=int(sys.argv[-4])
PyramidHeight=int(sys.argv[-3])
...
tableToStructuredGrid1.WholeExtent = [0, PyramidBase/dimensionReduction, 0, PyramidBase/dimensionReduction, PyramidHeight/2-1,PyramidHeight/2+1]
...
slice1.SliceType.Origin = [PyramidBase/(dimensionReduction*2) , PyramidBase/(dimensionReduction*2), PyramidHeight/2]
...
renderView1.CameraPosition = [PyramidBase/(dimensionReduction*2), PyramidBase/(dimensionReduction*2), PyramidHeight]
renderView1.CameraFocalPoint = [ PyramidBase/(dimensionReduction*2), PyramidBase/(dimensionReduction*2), PyramidHeight/2]
renderView1.CameraViewUp = [0.0, 1.0, 0.0]
renderView1.CameraParallelScale = PyramidBase/(dimensionReduction*1.97)
