...
tableToStructuredGrid1.WholeExtent = [PyramidBase/2 - 1, PyramidBase/2+1, 0, PyramidBase/dimensionReduction, 0, PyramidHeight/dimensionReduction]
...
slice1.SliceType.Origin =  [PyramidBase/2 , PyramidBase/(dimensionReduction*2), PyramidHeight/(dimensionReduction*2)]
...
renderView1.CameraPosition =[PyramidBase, PyramidBase/(dimensionReduction*2), PyramidHeight/(dimensionReduction*2)]
renderView1.CameraFocalPoint =  [ PyramidBase/2, PyramidBase/(dimensionReduction*2), PyramidHeight/(dimensionReduction*2)]
