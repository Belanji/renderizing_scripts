...
tableToStructuredGrid1.WholeExtent = [0, dropletSize/(dimensionReduction),   dropletSize/2 -1 , dropletSize/2+1, 0, dropletSize/(dimensionReduction)]
...
renderView1.CameraPosition = [dropletSize/(dimensionReduction*2), dropletSize,dropletSize/(dimensionReduction*2)]
renderView1.CameraFocalPoint = [dropletSize/(dimensionReduction*2),dropletSize/2,dropletSize/(dimensionReduction*2)]
