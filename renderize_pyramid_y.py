...
tableToStructuredGrid1.WholeExtent =  [0, PyramidBase/dimensionReduction, PyramidBase/2-1, PyramidBase/2+1, 0, PyramidHeight/dimensionReduction]
...
slice1.SliceType.Origin = [PyramidBase/(dimensionReduction*2), PyramidBase/2, PyramidHeight/(dimensionReduction*2)]
...
renderView1.CameraPosition = [PyramidBase/(dimensionReduction*2), PyramidBase, PyramidHeight/(dimensionReduction*2)]
renderView1.CameraFocalPoint = [PyramidBase/(dimensionReduction*2), PyramidBase/2, PyramidHeight/(dimensionReduction*2)]
